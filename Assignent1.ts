Q1 
const c = "Kaveesh";
console.log(c + " intial Value"); //Kaveesh
...
//Q4 :
let names = ['Kaveesh', 'Niteesh', 'Mukesh'];
var Q4 = (names) => {
...
userFriends("Balaji", "Nishanth", "Anto", "Nygin");
let arr = ["Jerish", "Alfy", "Nithish", "Ashwin", "Shad"];
userFriends("Reflin", ...arr);
